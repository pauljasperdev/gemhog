...
Purpose: Centralize environment variable handling - all packages should use @gemhog/env, not dotenv directly.
Output: drizzle.config.ts imports from @gemhog/env/server, dotenv removed from packages/core
</objective>
