...
Output: Clean auth service with static imports, no Polar dependencies anywhere
in codebase </objective>
...
@packages/core/src/auth/auth.service.ts @packages/core/package.json
@packages/env/src/server.ts @apps/web/src/lib/auth-client.ts
@apps/web/src/app/dashboard/dashboard.tsx @apps/web/package.json </context>
