...
Purpose: Protect AI endpoint from abuse - validate input payloads and limit
request frequency Output: AI endpoint with Zod validation for messages and rate
limiting middleware </objective>
...
@apps/server/src/index.ts @apps/server/package.json </context>
